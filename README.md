...
- Spotify OAuth login (Authorization Code + PKCE, no client secret shipped in the app)
...
### Limitation: only your own playlists
...
MIT [LICENSE](LICENSE). All credit for the original application goes to [afkarxyz](https://github.com/afkarxyz) and the SpotiFLAC project.
